            ...
            {!showResults ? (
              <div className="text-center mb-8">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                  ...
                  <Link href="/take-quiz" className="px-6 py-3 rounded-full font-medium bg-transparent border border-red-500 dark:border-[#1C81E7] text-red-500 dark:text-[#1C81E7] hover:bg-red-50 dark:hover:bg-[#1C81E7]/10 transition-colors">
                    I Don't Know My Type - Take Quiz
                  </Link>
                </div>
                
                {/* Information about MBTI */}
                <div className="mt-12 text-left bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
